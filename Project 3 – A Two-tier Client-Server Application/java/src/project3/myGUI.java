...
public class myGUI extends JFrame {
    ...
    public myGUI() throws ClassNotFoundException, SQLException, IOException {
    ...
    public void createInstanceGUIComponents() throws ClassNotFoundException, SQLException, IOException {
        String[] dbString = {"project4.properties", "modeldb.properties"};
        String[] userString = {"root.properties", "client.properties", "dataentryuser.properties", "theaccountant.properties"};
